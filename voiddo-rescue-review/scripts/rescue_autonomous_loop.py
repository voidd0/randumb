...
CORE_AGENTS: tuple[tuple[str, dict], ...] = (
    ...
    ("lead_quality_diagnostics_agent", {"limit": 200}),
    ("scout_source_feedback_agent", {"limit": 200, "dry_run": False}),
    ("quality_aware_regional_target_plan_agent", {"limit_targets": 5}),
    ("outreach_preview_queue_agent", {"limit": 40}),
    ("outreach_preview_dedupe_agent", {"limit": 200, "apply": True}),
