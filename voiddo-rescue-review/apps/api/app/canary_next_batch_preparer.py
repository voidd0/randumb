        ...
        return json_safe(
            {
                ...
                "sent_count": plan.get("sent_or_bounced_count", plan.get("sent_count", 0)),
                "sent_or_bounced_count": plan.get("sent_or_bounced_count", plan.get("sent_count", 0)),
                "smtp_sent_count": plan.get("smtp_sent_count", 0),
                "bounced_count": plan.get("bounced_count", 0),
